<template>
  <div class="component">
    ...
    <div>
      ...
      <p>Five Star Service Pros is a local female-owned company with extensive experience in all areas of residential and commercial plumbing. Quality training, experience, and equipment are critical to ensuring that our customers receive the highest-level service on every job.</p>
    </div>
    <!-- Main Services -->
